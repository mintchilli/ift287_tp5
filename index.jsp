...
<html>
	<head>
		...
		<meta name="description" content="Page d'accueil du système de gestion du jardin collectif.">
		...
		<div class="container">
			...
			<form action="Login" method="POST">
			    <div class="form-group">
				    ...
				    <input class="form-control" type="TEXT" name="userIdBD" value="<%= (request.getAttribute("userIdBD") != null ? (String)request.getAttribute("userIdBD") : "") %>">
			    </div>
			    <div class="form-group">
			    ...
			    <div class="form-group">
				    ...
				    <select class="custom-select" name="serveur">
				    	<option value="local" <%= (request.getAttribute("serveur") != null ? (((String)request.getAttribute("serveur")).equals("local") ? "selected" : "") : "selected") %>>local
			    ...
			    <div class="form-group">
			    	...
			    	<input class="form-control" type="TEXT" name="bd" value="<%= (request.getAttribute("bd") != null ? (String)request.getAttribute("bd") : "") %>" >
			    </div>
