...
public class Plantes extends HttpServlet
{
    ...
    {
        System.out.println("Servlet Plantes : POST");
        try
        {
            if (!JardinHelper.peutProceder(getServletContext(), request, response))
            {
                System.out.println("Servlet Plantes : POST ne peut pas procéder.");
    ...
    {
        System.out.println("Servlet Plantes : GET");
        if (JardinHelper.peutProceder(getServletContext(), request, response))
        {
            System.out.println("Servlet Plantes : GET dispatch vers plantes.jsp");
